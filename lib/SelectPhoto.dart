...
class SelectPhoto extends StatefulWidget {
  final index;
   final pageno;
  SelectPhoto(this.index,this.pageno){print(index);}
  @override
        ...
        leading: IconButton (onPressed: (){Navigator.pop(context);},
           icon: Icon(Icons.arrow_back),),
            ...
            flexibleSpace: new FlexibleSpaceBar( 
              title: Text(PhotoDetail.details[widget.index]['name'],textAlign: TextAlign.start,), 
              background:
              Hero(
            tag: PhotoDetail.details[widget.index],
                child: Container(
                  child: Image.asset(PhotoDetail.details[widget.index]['img'],
                          fit: BoxFit.cover),
                ),
              ),
            ),
      ...
      child: Container(
        ...
        children: <Widget>[
          Padding(
            ...
            child: Text(PhotoDetail.details[widget.index]['name'],style: TextStyle(fontSize: 22,),),
          ),
          Row(children: <Widget>[
            Padding(
          ...
          Text(PhotoDetail.details[widget.index]['place'],style: TextStyle(fontSize:16),),
          Padding(
              padding: const EdgeInsets.only(left:5,right:5),
            child: InkWell(onTap: (){},
                  ...
                  child: Container(
                            decoration: BoxDecoration(color: Colors.green,borderRadius: BorderRadius.all(Radius.circular(10))
                              ...
                              child: Row(children: <Widget>[
                                ...
                                Text(PhotoDetail.details[widget.index]['rating'],style: TextStyle(color: Colors.white,fontSize: 14),),
                              ],),
                            ),
                ),
