...
class SelectVenue extends StatefulWidget {
  final index;
   final pageno;
  SelectVenue(this.index,this.pageno){print(index);}
  @override
      ...
      child: Container(
        ...
        children: <Widget>[
          Padding(
            ...
            child: Text(VenueDetail.details[widget.index]['name'],style: TextStyle(fontSize: 22,),),
          ),
          Row(children: <Widget>[
            Padding(
          ...
          Text(VenueDetail.details[widget.index]['place'],style: TextStyle(fontSize:16),),
          Padding(
              padding: const EdgeInsets.only(left:5,right:5),
            child: InkWell(onTap: (){},
